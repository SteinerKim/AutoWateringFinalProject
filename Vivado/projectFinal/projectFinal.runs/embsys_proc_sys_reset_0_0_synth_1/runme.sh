...
HD_PWD='C:/projects/kim/ECE544/projectFinal/projectFinal.runs/embsys_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_proc_sys_reset_0_0.tcl
