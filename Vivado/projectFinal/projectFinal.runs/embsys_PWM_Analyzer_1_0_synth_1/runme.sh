...
HD_PWD='C:/projects/kim/ECE544/projectFinal/projectFinal.runs/embsys_PWM_Analyzer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_PWM_Analyzer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_PWM_Analyzer_1_0.tcl
