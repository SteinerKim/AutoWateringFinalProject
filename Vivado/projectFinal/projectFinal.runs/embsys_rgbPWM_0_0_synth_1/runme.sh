...
HD_PWD='C:/projects/kim/ECE544/projectFinal/projectFinal.runs/embsys_rgbPWM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_rgbPWM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_rgbPWM_0_0.tcl
