...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../projectFinal.gen/sources_1/bd/embsys/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../projectFinal.gen/sources_1/bd/embsys/ipshared/7698" \
       +incdir+"../../../../projectFinal.gen/sources_1/bd/embsys/ipshared/ec67/hdl" \
       +incdir+"../../../../projectFinal.gen/sources_1/bd/embsys/ipshared/7698" \
       +incdir+"../../../../projectFinal.gen/sources_1/bd/embsys/ip/embsys_nexys4io_0_0/drivers/nexys4io_v1_0/src" \
       -input simulate.do
}
