...
-- Command     : write_vhdl -force -mode funcsim -rename_top embsys_PWM_Analyzer_1_0 -prefix
--               embsys_PWM_Analyzer_1_0_ embsys_PWM_Analyzer_0_0_sim_netlist.vhdl
...
entity embsys_PWM_Analyzer_1_0_pulseLength is
  port (
...
end embsys_PWM_Analyzer_1_0_pulseLength;

architecture STRUCTURE of embsys_PWM_Analyzer_1_0_pulseLength is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0_S00_AXI is
  port (
...
end embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0_S00_AXI;

architecture STRUCTURE of embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0_S00_AXI is
...
pulse_length: entity work.embsys_PWM_Analyzer_1_0_pulseLength
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
...
end embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0;

architecture STRUCTURE of embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0 is
begin
PWM_Analyzer_v1_0_S00_AXI_inst: entity work.embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embsys_PWM_Analyzer_1_0 is
  port (
    pwm : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of embsys_PWM_Analyzer_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of embsys_PWM_Analyzer_1_0 : entity is "embsys_PWM_Analyzer_0_0,PWM_Analyzer_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of embsys_PWM_Analyzer_1_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of embsys_PWM_Analyzer_1_0 : entity is "PWM_Analyzer_v1_0,Vivado 2022.2";
end embsys_PWM_Analyzer_1_0;

architecture STRUCTURE of embsys_PWM_Analyzer_1_0 is
...
inst: entity work.embsys_PWM_Analyzer_1_0_PWM_Analyzer_v1_0
     port map (
